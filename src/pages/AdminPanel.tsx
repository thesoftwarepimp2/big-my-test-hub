  ...
  const orders = [
    {
      ...
      items: [
        { name: 'MEGA ROLLER FLOUR 10KG', quantity: 5, price: 18.50 },
        { name: 'BUTTERCUP MARGARINE', quantity: 10, price: 6.50 }
      ],
      total: 157.50,
      status: 'pending',
      date: '2024-01-15',
    ...
    },
    {
      ...
      items: [
        { name: 'POTATOES 10KG', quantity: 20, price: 6.75 },
        { name: 'KOO BAKED BEANS 410G', quantity: 50, price: 2.85 }
      ],
      total: 277.50,
      status: 'processing',
      date: '2024-01-14',
    ...
    },
    {
      ...
      items: [
        { name: 'CHIMOMBE FULL CREAM MILK 1L', quantity: 100, price: 4.25 }
      ],
      total: 425.00,
      status: 'delivered',
      date: '2024-01-13',
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <Button 
                            size="sm" 
                            className="bg-bgl-yellow-400 hover:bg-bgl-yellow-500 text-gray-900"
